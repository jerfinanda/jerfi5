...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            self.log("G-OPERATION LOGIN SUCCESS")
            self.log("HELLO, %s " % self.profile.displayName)
            ...
            if linex in ang:
                 ...
                 self.sendMessage("ucfb857ee3e7d641101ae90610752e4d7", 'Halo ' + self.getContact(linex).displayName  + ",Thanks for This :)" )   